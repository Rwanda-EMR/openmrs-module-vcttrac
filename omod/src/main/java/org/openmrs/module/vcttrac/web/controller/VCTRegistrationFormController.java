...
public class VCTRegistrationFormController extends ParameterizableViewController {
	...
	private void initRegisteredClientForEdit(HttpServletRequest request, ModelAndView mav) {
		...
		mav.addObject("phoneNumber",
				client.getClient().getAttribute(Context.getPersonService()
						.getPersonAttributeTypeByUuid(MoHOrderEntryBridgeConstants.PERSONATTRIBUTE_UUID_PHONENUMBER)
						.getName()));
		mav.addObject("peerEducator",
				client.getClient()
						.getAttribute(Context.getPersonService()
								.getPersonAttributeTypeByUuid(
										MoHOrderEntryBridgeConstants.PERSONATTRIBUTE_UUID_PEER_EDUCATOR_NAME)
								.getName()));
		mav.addObject("peerEducatorPhoneNumber",
				client.getClient()
						.getAttribute(Context.getPersonService()
								.getPersonAttributeTypeByUuid(
										MoHOrderEntryBridgeConstants.PERSONATTRIBUTE_UUID_PEER_EDUCATOR_PHONENUMBER)
