...
public class VCTClient {
	 ...
	 * 
	 * @param uuid
	 *            the UUID associated to the object
	 */
	 ...
	 * 
	 * @param location
	 *            the location associated to the object
	 */
	...
	/**
	 * Return <b>NULL</b> when the reception of result by the client has not
	 * been done<br/>
	 * Return <b>1</b> when the client decided <i>to join the HIV program</i>
	 * <br/>
	 * Return <b>0</b> when the client decided <i>to be transferred to another
	 * location</i><br/>
	 * Return <b>2</b> when the client <i>denied to join the HIV program</i>
	 * <br/>
	 * 
	 ...
	 * 
	 * @param client
	 *            the person object associated to the vctclient object to set
	 */
	 ...
	 * 
	 * @param counselingObs
	 *            the obs group corresponding to counseling
	 */
	 ...
	 * 
	 * @param resultObs
	 *            the obs group corresponding to result to set
	 */
	 ...
	 * 
	 * @return <i>true</i> if the object is archived <i>false</i> if the object
	 *         is not archived
	 */
	 ...
	 * 
	 * @param archived
	 *            <i>true</i> if the object is archived <i>false</i> if the
	 ...
	 *            the date or registration to set
	 */
	 ...
	 * 
	 * @return <i>true</i> if the object is voided <i>false</i> if the object is
	 *         not voided
	 */
	 ...
	 * 
	 * @param voided
	 *            the status (voided or not) of the object to set
	 */
	 ...
	 * 
	 * @param dateVoided
	 *            the date when the object has been voided on to set
	 */
	 ...
	 * 
	 * @param voidedBy
	 *            the user who voided the object to set
	 */
	 ...
	 * 
	 * @return the type of counseling used <i>1</i> if the type used is
	 *         individual counseling <i>2</i> if the type used is couple
	 *         counseling
	 */
	 ...
	 * 
	 * @param typeOfCounseling
	 *            the type of counseling to set <i>1</i> if the type used is
	 *            individual counseling <i>2</i> if the type used is couple
	 *            counseling
	 */
	 ...
	 * 
	 * @param partner
	 *            the partner corresponding to the object to set
	 */
	...
	/**
	 * Change the state of the client, the result <i>have or have not</i> been
	 * received
	 * 
	 * @param received
	 *            <i>true</i> if the client have received the result
	 *            <i>false</i> if the client have not yet received the result
	 */
	 ...
	 * 
	 * @return <i>true</i> if the client have received the result <i>false</i>
	 *         if the client have not yet received the result
	 */
	...
	public enum RegistrationEntryPoint {
		...
		RegistrationEntryPoint(String displayName) {
